...
if (ColorThief.prototype.getColor = function (a, b) {
  ...
  "undefined" == typeof b && (b = 10), ("undefined" == typeof c || c < 1) && (c = 10);for (var d, e, f, g, h, i = new CanvasImage(a), j = i.getImageData(), k = j.data, l = i.getPixelCount(), m = [], n = 0; n < l; n += c) {
  ...
  function a(a, b, c) {
    ...
    function h(a, b) {
    ...
    }if (!a.length || c < 2 || c > 256) return !1;var i = e(a),
      ...
      o.push(n.pop());
    }h(o, c - o.size());for (var p = new d(); o.size();) {
      p.push(o.pop());
    }return p;
  }var i = 5,
      j = 8 - i,
